...
changeThemeBtn.addEventListener("click" , function () {
    ...
    if(documentElementHtml.contains("dark-theme")){
        ...
        this.innerHTML = iconDarkTheme
    }else{
        window.localStorage.setItem("theme","light-theme")
        this.innerHTML = iconLightTheme
    }
})
...
if(window.localStorage.getItem("theme") === "dark-theme"){
    ...
    changeThemeBtn.innerHTML = iconDarkTheme;
